const AchievementsList = [
  {
    id: 1,
    competitionName: "Decode Derby",
    year: "2025",
    rank: "1st Place",
    skillsRequired: ["C", "JAVA", "Problem Solving", "Algorithms", "Data Structures"],
  ...
  },
  {
    ...
    description: "Built a comprehensive mobile application with features to determine eco-friendly products and promote sustainable living.",
    certificateImage: "/assets/achievements/appDesign.jpg",
    icon: "🥉",
    status: "Third Place"
  },
  {
  ...
  },
  {
    ...
    year: "2022",
    rank: "1st Place",
    skillsRequired: ["C++", "OOP", "Problem Solving"],
    category: "Competitive Programming",
